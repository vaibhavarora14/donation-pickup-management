      ...
      <section className="blog-section" id="blog">
        ...
        <div className="blog-cards">
          <div className="blog-card">
            <img
              src="https://www.figma.com/api/mcp/asset/3d95b9fb-324c-4695-97e2-12df7db0dc28"
              alt="Blog"
          ...
          <div className="blog-card">
            <img
              src="https://www.figma.com/api/mcp/asset/d9dd71a4-66e8-4b13-a52c-ecfea11fd82f"
              alt="Blog"
              className="blog-image"
            />
            <div className="blog-content">
          ...
          <div className="blog-card">
            <img
              src="https://www.figma.com/api/mcp/asset/f91d9929-e396-4d21-bc72-e7cca01968f5"
              alt="Blog"
              className="blog-image"
            />
            <div className="blog-content">
