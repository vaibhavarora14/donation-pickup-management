  ...
  return (
    <div className="w-full min-h-screen bg-white font-sans">
      ...
      <section className="relative w-full h-[600px] md:h-[700px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-call-to-action/20 to-call-to-action/5"></div>
        <div className="relative z-10 text-center px-5">
          <h1 className="text-4xl md:text-6xl font-bold text-title mb-8">
      ...
      <section className="py-15 px-5 bg-white">
        <div className="max-w-[1200px] mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-15">
          <div className="text-center">
            ...
            <div className="text-3xl font-bold text-call-to-action mb-2">013 856</div>
            <div className="text-sm text-paragraph">Total Lives Impacted</div>
          </div>
          <div className="text-center">
            <div className="text-4xl mb-2">🎁</div>
            <div className="text-3xl font-bold text-call-to-action mb-2">013 856</div>
            <div className="text-sm text-paragraph">Total Old Items Donated</div>
          </div>
          <div className="text-center">
            <div className="text-4xl mb-2">🏢</div>
            <div className="text-3xl font-bold text-call-to-action mb-2">013 856</div>
            <div className="text-sm text-paragraph">Total NGOs Reached</div>
          </div>
          <div className="text-center">
            <div className="text-4xl mb-2">📋</div>
            <div className="text-3xl font-bold text-call-to-action mb-2">013 856</div>
            <div className="text-sm text-paragraph">Total NGOs listed</div>
          </div>
        </div>
      </section>
      ...
      <section className="py-15 px-5">
        <div className="max-w-[1200px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-15 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-title mb-4">Welcome to HappieeSouls!</h2>
              <p className="text-lg text-paragraph mb-4 font-medium">
      ...
      <section className="py-15 px-5 bg-gray-50" id="how-it-works">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-title mb-8">What we do?</h2>
      ...
      <section className="py-15 px-5">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-title text-center mb-12">How we work</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              <div className="text-5xl mb-4">🚗</div>
              <h3 className="text-xl font-semibold text-title mb-3">Schedule a Pickup</h3>
            ...
            <div className="text-center p-6">
              <div className="text-5xl mb-4">📦</div>
              <h3 className="text-xl font-semibold text-title mb-3">Donate at your Doorstep</h3>
              <p className="text-paragraph leading-relaxed">
            ...
            <div className="text-center p-6">
              <div className="text-5xl mb-4">🎁</div>
              <h3 className="text-xl font-semibold text-title mb-3">Get Rewards</h3>
              <p className="text-paragraph leading-relaxed">
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-white rounded-lg shadow-sm">
              <div className="text-5xl mb-4">👤</div>
              <h3 className="text-xl font-semibold text-title mb-3">Connect</h3>
            ...
            <div className="text-center p-6 bg-white rounded-lg shadow-sm">
              <div className="text-5xl mb-4">🤝</div>
              <h3 className="text-xl font-semibold text-title mb-3">Engage</h3>
              <p className="text-paragraph">
            ...
            <div className="text-center p-6 bg-white rounded-lg shadow-sm">
              ...
              <h3 className="text-xl font-semibold text-title mb-3">Help</h3>
              <p className="text-paragraph">
      ...
      <section className="py-15 px-5 bg-gray-50">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-title mb-4">Donate Almost Anything</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            <div className="flex flex-col items-center p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow cursor-pointer">
              ...
              />
              <span className="text-sm font-medium text-title">Shoes</span>
            </div>
            <div className="flex flex-col items-center p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow cursor-pointer">
              <img
                ...
                className="w-16 h-16 object-contain mb-3"
              />
              <span className="text-sm font-medium text-title">Stationery</span>
            </div>
            <div className="flex flex-col items-center p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow cursor-pointer">
              <img
                ...
                className="w-16 h-16 object-contain mb-3"
              />
              <span className="text-sm font-medium text-title">Bags</span>
            </div>
            <div className="flex flex-col items-center p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow cursor-pointer">
              <img
                ...
                className="w-16 h-16 object-contain mb-3"
              />
              <span className="text-sm font-medium text-title">Clothes</span>
            </div>
            <div className="flex flex-col items-center p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow cursor-pointer">
              <img
                src="https://www.figma.com/api/mcp/asset/a2a5b27c-6acc-49df-9df7-6f2ff70011d4"
            ...
            <div className="flex flex-col items-center p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow cursor-pointer relative">
              <img
                ...
                className="w-16 h-16 object-contain mb-3"
              />
              <span className="text-sm font-medium text-title mb-1">More Donation</span>
              <span className="text-xs font-bold text-call-to-action uppercase">VIEW MORE</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-15 px-5">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-title text-center mb-4">Support a cause close to your heart</h2>
          <p className="text-lg text-paragraph text-center mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="relative rounded-lg overflow-hidden group cursor-pointer">
              <img
                ...
                className="w-full h-64 object-cover"
              />
              <div className="absolute inset-0 bg-main/20 group-hover:bg-main/30 transition-colors"></div>
            </div>
            <div className="relative rounded-lg overflow-hidden group cursor-pointer">
              <img
                ...
                className="w-full h-64 object-cover"
              />
              <div className="absolute inset-0 bg-call-to-action/20 group-hover:bg-call-to-action/30 transition-colors"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-15 px-5 bg-gray-50">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-title text-center mb-4">OUR BRAND COLLABORATIONS</h2>
          <p className="text-base text-paragraph text-center mb-12 max-w-2xl mx-auto">
      ...
      <section className="py-15 px-5">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-title text-center mb-12">Our Corporate Partners</h2>
      ...
      <section className="py-15 px-5 bg-gray-50">
        <div className="max-w-[1200px] mx-auto">
          <p className="text-sm font-semibold text-call-to-action text-center mb-2 uppercase tracking-wide">Testimonials</p>
          <h2 className="text-3xl md:text-4xl font-bold text-title text-center mb-12">
          ...
          <div className="max-w-3xl mx-auto bg-white rounded-lg p-8 md:p-12 shadow-lg">
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              />
              <div>
                <p className="text-lg font-semibold text-title">Shalini Jain</p>
              </div>
            </div>
            <div className="flex items-center justify-center gap-4">
              <Button variant="ghost" size="small" className="text-2xl">←</Button>
              <div className="flex gap-2">
                <span className="w-2 h-2 rounded-full bg-call-to-action"></span>
              ...
              <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    <span className="px-3 py-1 bg-gray-100 text-xs font-medium text-paragraph rounded-full">Environment</span>
                    <span className="px-3 py-1 bg-gray-100 text-xs font-medium text-paragraph rounded-full">Lifestyle</span>
                    <span className="px-3 py-1 bg-gray-100 text-xs font-medium text-paragraph rounded-full">SustainableLifestyle</span>
                  </div>
      ...
      <section className="py-15 px-5 bg-gray-50" id="contact">
        <div className="max-w-[1200px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-title mb-8">Be a part of our story</h2>
      ...
      {/* Newsletter Section */}
      <section className="py-15 px-5 bg-call-to-action">
